...
// coding agents (Claude Code, Codex, Droid, OpenCode, OpenClaw, Hermes). It mirrors the happy-cli AgentBackend
...
type Config struct {
	ExecutablePath string            // path to CLI binary (claude, codex, droid, opencode, openclaw, or hermes)
	Env            map[string]string // extra environment variables
	Logger         *slog.Logger
}

// New creates a Backend for the given agent type.
// Supported types: "claude", "codex", "droid", "opencode", "openclaw", "hermes".
func New(agentType string, cfg Config) (Backend, error) {
	...
	default:
		return nil, fmt.Errorf("unknown agent type: %q (supported: claude, codex, droid, opencode, openclaw, hermes)", agentType)
	}
}
